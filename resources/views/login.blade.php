...
<form id="login_form">
    <div class="svgContainer">
        <div style = 'text-align:center'>
            <svg style = 'height:150px;'class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                <defs>
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="text" id="email" class="email" maxlength="256" required/>
...
<script src="/public/js/adminLoginForm.js"></script>
